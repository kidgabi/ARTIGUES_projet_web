    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Contact</h1>
                <p class="lead"> Pour tout bug ou proposition d'amélioration, n'hésitez pas à envoyer un mail à l'adresse suivante : gabriel.artigues@polytech.univ-mont2.fr </p>
