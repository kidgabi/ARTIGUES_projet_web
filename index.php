...
<head>
    ...
    <title>SGTF - Système de Gestion de Tournoi FIFA</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Système de Gestion de Tournoi Fifa</h1>
                <p class="lead">Bienvenue ! Veux-tu t'inscrire à un tournoi ou en créer un ?</p>
					
				<p>
					<!-- on crée 2 boutons pour savoir ce que veut faire l'utilisateur -->
					<a href="form_joueur.php"><input type="button" value="S'inscrire" /></a>
					<a href="form_orga.php"><input type="button" value="Créer" /></a>
				</p>
				</br>
				</br>
				<!-- on crée un tableau avec les tournois pour que l'utilisateur puisse en choisir un et trouver plus d'infos -->
				<form method="post" action="consultation_tournoi.php">
