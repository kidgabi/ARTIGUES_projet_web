    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
			 ...
			 <!-- on affiche les tournois pouvant etre modifiés -->
				<form method="post" action="cible_mod_tournoi.php">
				   <table id="tab" style ="text-align:center">
						<caption class="text-center policy2">Choisi le tournoi à modifier</caption>
							<colgroup>
